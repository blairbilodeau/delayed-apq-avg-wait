...
point_spacing <- 4
b_seq <- seq(0,1,0.01)
adj_b1 <- Avg_MM1.b(mu=1, lam1=0.5, lam2=0.3, b=b_seq, d=2, K=750)
adj_b2 <- Avg_MM1.b(mu=1, lam1=0.5, lam2=0.3, b=b_seq, d=4, K=750)
adj_b3 <- Avg_MM1.b(mu=1, lam1=0.5, lam2=0.3, b=b_seq, d=6, K=750)
adj_b4 <- Avg_MM1.b(mu=1, lam1=0.5, lam2=0.3, b=b_seq, d=8, K=750)
...
point_spacing <- 4
d_seq <- seq(0,15,0.3)
adj_d1 <- Avg_MM1.d(mu=1, lam1=0.5, lam2=0.3, b=0.2, d=d_seq, K=750)
adj_d2 <- Avg_MM1.d(mu=1, lam1=0.5, lam2=0.3, b=0.4, d=d_seq, K=750)
adj_d3 <- Avg_MM1.d(mu=1, lam1=0.5, lam2=0.3, b=0.6, d=d_seq, K=750)
adj_d4 <- Avg_MM1.d(mu=1, lam1=0.5, lam2=0.3, b=0.8, d=d_seq, K=750)
adj_d5 <- Avg_MM1.d(mu=1, lam1=0.5, lam2=0.3, b=1, d=d_seq, K=750)
